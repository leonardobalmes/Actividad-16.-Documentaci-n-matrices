...
Durante el ejercicio se aplicaron las operaciones básicas del álgebra matricial: suma, resta, multiplicación y transposición. Esto permitió comprobar que el orden en la multiplicación de matrices altera el resultado ($AB \neq BA$) y que la transpuesta transforma las filas en columnas, reforzando la comprensión de estos conceptos fundamentales.
